...
void Node::updateTextString(){
    gCostText.setString(floatToStringWithPrecision(gCost,1));
    hCostText.setString(floatToStringWithPrecision(hCost,1));
    fCostText.setString(floatToStringWithPrecision(fCost(),1));
}
